...
import cu.uno.via.R;
import cu.uno.via.ui.notas.NotasFragment;

public class ActivityNuevaNota extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        if (aux.length() != 0) {
            if (!textoNota.equals(aux)) {
                AlertDialog.Builder builder = new AlertDialog.Builder(ActivityNuevaNota.this);
                builder
                        .setTitle("Guardar")
                        ...
                        .setPositiveButton("Guardar", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                if (!edicion) {
                                    ...
                                    NotasFragment.listaNotas.add(modeloNotas);

                                    basedatos = new Basedatos(ActivityNuevaNota.this, "datos.db");
                                    basedatos.agregarNota(nota.getText().toString());

                                    Toast.makeText(ActivityNuevaNota.this, "Nota guardada", Toast.LENGTH_SHORT).show();
                                    finish();
                                } else {
                                    ModeloNotas modeloNotas = new ModeloNotas();
                                    modeloNotas.setDescripcion(nota.getText().toString());
                                    ...
                                    NotasFragment.listaNotas.set(posicion, modeloNotas);
                                    Toast.makeText(ActivityNuevaNota.this, "Nota editada", Toast.LENGTH_SHORT).show();
                                    finish();
                                }
                            }
                        })
