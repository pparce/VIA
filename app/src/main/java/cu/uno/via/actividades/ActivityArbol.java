...
public class ActivityArbol extends AppCompatActivity implements CallbackArbolArticulos {
    ...
    private void setDialog(String title, String message) {
        ...
        LayoutInflater layoutInflater = LayoutInflater.from(ActivityArbol.this);
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(ActivityArbol.this);
        builder
                .setTitle(title)
                .setView(myview)
