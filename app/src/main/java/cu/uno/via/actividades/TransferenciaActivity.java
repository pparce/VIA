...
import cu.uno.via.R;
import cu.uno.via.utiles.USSDService;
...
public class TransferenciaActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        isActivado = isAccessibilityServiceEnabled(TransferenciaActivity.this, USSDService.class);
            ...
            public void onClick(View view) {
                ...
                if (password.length() == 4) {
                    if (mSignalStrength < 0) {
                        if (isAccessibilityServiceEnabled(TransferenciaActivity.this, USSDService.class)) {
    ...
    private BroadcastReceiver receiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            editor.commit();
            Toast.makeText(TransferenciaActivity.this, "Aplicacion desbloqueada", Toast.LENGTH_SHORT).show();
