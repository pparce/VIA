...
public class VisualizarSenalesActivity extends AppCompatActivity implements OnScrollCallback {
    ...
    private void Inicializar(){
        ...
        pagerAdaptor = new ViewPagerSenalesAdapter(VisualizarSenalesActivity.this, getSupportFragmentManager(), tab.getTabCount());
