package cu.pparce.via.Utiles.qrcodescanner;
...
import cu.pparce.via.Utiles.qrcodescanner.camera.CameraManager;
import cu.pparce.via.Utiles.qrcodescanner.decode.CaptureActivityHandler;
import cu.pparce.via.Utiles.qrcodescanner.decode.DecodeImageCallback;
import cu.pparce.via.Utiles.qrcodescanner.decode.DecodeImageThread;
import cu.pparce.via.Utiles.qrcodescanner.decode.DecodeManager;
import cu.pparce.via.Utiles.qrcodescanner.decode.InactivityTimer;
import cu.pparce.via.Utiles.qrcodescanner.view.QrCodeFinderView;
...
public class QrCodeActivity extends AppCompatActivity implements Callback, OnClickListener {
    ...
    private final String GOT_RESULT = "com.parce.paleer.qrcodescanner.got_qr_scan_relult";
    private final String ERROR_DECODING_IMAGE = "com.parce.paleer.qrcodescanner.error_decoding_image";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.qr_code_header_bar);
